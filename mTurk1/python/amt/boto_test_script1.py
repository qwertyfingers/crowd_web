...
title = 'Title: Report on events in a simulation4'
description = ('Description: Report on events in a simulation')
...
overview.append(FormattedContent('<a target="_blank"'
                                 ' href="http://qwertyfinger.webfactional.com">'
                                 ' href="http://qwertyfinger.webfactional.com</a>'))
